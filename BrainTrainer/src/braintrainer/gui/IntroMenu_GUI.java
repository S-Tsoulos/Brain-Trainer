...
public final class IntroMenu_GUI extends JFrame {
    ...
    public IntroMenu_GUI() {
        ...
        checkBoxGroup = new ButtonGroup(); //button group gia na mporw na xeiristo kalitera tis leitourgies ton checkboxes
    ...
    //Method actionPerformed for toMainMenu ,  dexetai to onoma kai tin epilegmeni diskolia tou xristi , dimiourgei antikeimeno xristi me auta ta stoixeia kai sto telos ta 
    //apothikeuei ston leaderboardManager , telos dimiourgei to kirios menu kleinontas tautoxrona to paron
