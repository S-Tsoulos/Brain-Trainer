...
public final class MainMenu_GUI  {
    ...
    Gameboard_GUI gameboard_GUI; //gia tin enarksi tou paixnidiou
    private JFrame frame; //vasiko frame
    private JPanel contentPane; //panel me kataliles idiotites
    ...
    //Method actionPerformed gia to startGame , dimiourgei ton pinaka me ta koumpia.
    ...
    //Method actionPerformed for abandonGame , o pinakas tou paixnidiou kleinei kai dinei ti dinatotita dimiourgias neou paixnidiou apo tin arxi.
    ...
    //Method actionPerformed for pause_game_btn , meso tis flag 'pausedFlag' vazei to paixnidi se anastoli kanontas ola ta kounpia disabled mexri na ksanapatithei i "resume game"
    ...
    //Method actionPerformed for show_leaderboard_btn dimiourgei antikeimeno tupou LeaderboardManager kai emfanizei ton pinaka statistikon.
    ...
    //Method actionPerformed for rules_button pop up menu me tous kanones
    ...
    //Method actionPerformed for about_button  pop up menu me plirofories
    ...
    //method for generate menu , automata dimiourgimenou ipomenou sto parathira meso tou netbeans
