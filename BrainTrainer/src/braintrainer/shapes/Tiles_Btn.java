...
/**
 * Abstract class Tiles_Btn - apotelei tin klassi tin opoia klironomoune ola ta eidi tile Ex.
 * ('Tetragono','Kiklos','Trigono','Romvos', 'OrthogParalilogramo','Joker').
 * kanei extend ti klassi JButton gia na exei ta functions enos JButton kai orizei tis koines leitourgies olon ton tile kanontas abstract autes pou tha ilopoiisoun ksexorista to kathe tile
 */
